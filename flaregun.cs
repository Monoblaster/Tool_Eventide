datablock AudioProfile(flareGunFireSound)
{
	filename    = "./assets/flaregun_fire.wav";
	description = AudioDefault3d;
	preload = true;
};
datablock AudioProfile(flareGunLoadSound : flareGunFireSound)
{
	filename    = "./assets/flaregun_load.wav";
	description = AudioClose3d;
};
datablock AudioProfile(flareGunBreakSound : flareGunLoadSound)
{
	filename    = "./assets/flaregun_break.wav";
};
datablock AudioProfile(flareGunUnBreakSound : flareGunLoadSound)
{
	filename    = "./assets/flaregun_unbreak.wav";
};
datablock AudioProfile(flareGunDryFireSound : flareGunLoadSound)
{
	filename    = "./assets/flaregun_dryfire.wav";
};
datablock AudioProfile(flareGunCockSound : flareGunLoadSound)
{
	filename    = "./assets/flaregun_cock.wav";
};
datablock AudioProfile(flareGunExplosionA1Sound : flareGunLoadSound)
{
	filename    = "./assets/flaregun_explosionA1.wav";
	description = AudioDefault3D;
};
datablock AudioProfile(flareGunExplosionA2Sound : flareGunLoadSound)
{
	filename    = "./assets/flaregun_explosionA2.wav";
	description = AudioDefault3D;
};
...
datablock AudioProfile(flareGunLoopSound)
{
   filename    = "./assets/flaregun_loop.wav";
...
{
	serverPlay3d("flareGunExplosionA" @ getRandom(1,2) @ "Sound",%pos);
...
datablock ItemData(FlareItem)
{
	...
	shapeFile = "./assets/ammo_flaregun.dts";
	emap = 1;
	...
	uiName = "Flare";
	iconName = "./assets/icon_ammoflares";
